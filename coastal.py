	...
	def parse(self, response):
		for coastal in response.css('#main'):
			yield {
                ...
                'What does this team specialize in?' : coastal.css('h6::text').getall(),# + coastal.css('h6:nth-child(13)::text').get() + coastal.css('h6:nth-child(15)::text').get(),                'What is Conservation Biology and Shoreline Ecology?': coastal.css('p:nth-child(12)::text').get(),
